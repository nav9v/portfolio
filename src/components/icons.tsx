...
export const Icons = {
  ...
  telegram: (props: IconProps) => (
    ...
    >
      <path
        fill="currentColor"
        d="M9.993 15.365l-.39 4.476c.56 0 .804-.241 1.096-.53l2.63-2.517 5.454 3.982c1 .55 1.712.26 1.963-.93l3.557-16.697v-.001c.316-1.465-.53-2.038-1.506-1.683L1.4 9.865c-1.42.555-1.402 1.348-.243 1.705l4.902 1.529L18.913 5.8c.572-.354 1.09-.157.662.197"
      />
    </svg>
  ),
